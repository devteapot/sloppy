...
export function mapLlmNode(node: SlopNode | null | undefined): LlmState {
  ...
  return {
    ...
    selectedEndpointId: optionalStringProp(p, "selected_endpoint_id"),
    selectedProtocol: optionalStringProp(p, "selected_protocol"),
...
function mapLlmProfileNode(node: SlopNode): LlmProfile {
  ...
  return {
    ...
    kind: stringProp(p, "kind", "native"),
    endpointId: optionalStringProp(p, "endpoint_id"),
    protocol: optionalStringProp(p, "protocol"),
    ...
    authEnv: optionalStringProp(p, "auth_env"),
